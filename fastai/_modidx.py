  ...
  'syms': { 'fastai.basics': {},
            ...
            'fastai.callback.training': { 'fastai.callback.training.BnFreeze': ( 'callback.training.html#bnfreeze',
                                          ...
                                          'fastai.callback.training.GradientClip.before_step': ( 'callback.training.html#gradientclip.before_step',
                                                                                                 'fastai/callback/training.py'),
                                          'fastai.callback.training.GradientNoise': ( 'callback.training.html#gradientnoise',
                                                                                      'fastai/callback/training.py'),
                                          'fastai.callback.training.GradientNoise.__init__': ( 'callback.training.html#gradientnoise.__init__',
                                                                                               'fastai/callback/training.py'),
                                          'fastai.callback.training.GradientNoise.before_fit': ( 'callback.training.html#gradientnoise.before_fit',
                                                                                                 'fastai/callback/training.py'),
                                          'fastai.callback.training.GradientNoise.before_step': ( 'callback.training.html#gradientnoise.before_step',
                                                                                                  'fastai/callback/training.py'),
