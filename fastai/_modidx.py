  ...
  'syms': { 'fastai.basics': {},
            ...
            'fastai.callback.schedule': { 'fastai.callback.schedule.LRFinder': ( 'callback.schedule.html#lrfinder',
                                          ...
                                          'fastai.callback.schedule.LRFinder.before_validate': ( 'callback.schedule.html#lrfinder.before_validate',
                                                                                                 'fastai/callback/schedule.py'),
                                          'fastai.callback.schedule.LRWarmup': ( 'callback.schedule.html#lrwarmup',
                                                                                 'fastai/callback/schedule.py'),
                                          'fastai.callback.schedule.LRWarmup.__init__': ( 'callback.schedule.html#lrwarmup.__init__',
                                                                                          'fastai/callback/schedule.py'),
                                          'fastai.callback.schedule.LRWarmup.before_batch': ( 'callback.schedule.html#lrwarmup.before_batch',
                                                                                              'fastai/callback/schedule.py'),
                                          'fastai.callback.schedule.LRWarmup.before_fit': ( 'callback.schedule.html#lrwarmup.before_fit',
                                                                                            'fastai/callback/schedule.py'),
