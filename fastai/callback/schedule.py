...
# %% ../../nbs/14_callback.schedule.ipynb 14
def SchedPoly(start, end, power):
    "Polynomial schedule (of `power`) function from `start` to `end`"
    def _inner(pos): return start + (end - start) * pos ** power
    return _inner

# %% ../../nbs/14_callback.schedule.ipynb 27
...
# %% ../../nbs/14_callback.schedule.ipynb 32
def combined_cos(pct, start, middle, end):
    "Return a scheduler with cosine annealing from `start`→`middle` & `middle`→`end`"
    return combine_scheds([pct,1-pct], [SchedCos(start, middle), SchedCos(middle, end)])

# %% ../../nbs/14_callback.schedule.ipynb 37
@docs
...
# %% ../../nbs/14_callback.schedule.ipynb 45
@patch
...
# %% ../../nbs/14_callback.schedule.ipynb 56
@patch
...
# %% ../../nbs/14_callback.schedule.ipynb 59
@patch
...
# %% ../../nbs/14_callback.schedule.ipynb 66
@docs
...
# %% ../../nbs/14_callback.schedule.ipynb 77
...
# %% ../../nbs/14_callback.schedule.ipynb 80
...
# %% ../../nbs/14_callback.schedule.ipynb 83
