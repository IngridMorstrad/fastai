...
- **Total lines**: 25750
- **Dead code removed**: 32 lines total (13 from initial cleanup + 19 from test/import cleanup)
- **Other fixes applied**: replaced deprecated `pkg_resources` with `packaging.version` in setup.py

> **Note:** The total line count increased from the previous snapshot (21041) because new test files were added to the repository since the last count was taken. This increase is unrelated to this PR's changes.
...
### Round 2: Test file cleanup (19 lines)
