...
- **Total lines**: 25287
- **Dead code removed**: Consolidated duplicate test file `tests/test_dataloader.py` into `tests/test_data_loader.py`, eliminating ~528 lines of duplicated test code while preserving all unique test coverage.
