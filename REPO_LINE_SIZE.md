...
- **Total lines**: 25757
- **Dead code removed**: 25 lines (unused imports and dead functions across library and test files)
...
| `tests/test_optimizer.py` | Unused `import math`; unused imports `rms_prop_step`, `adam_step`, `OptimWrapper`; dead function `_set_grad` |
| `tests/test_losses.py` | Unused `import torch.nn.functional as F`; unused `import numpy as np` |
| `tests/test_layers.py` | Unused `import numpy as np` |
| `tests/test_metrics.py` | Unused `import torch.nn.functional as F`; unused import `optim_metric` |
| `tests/test_multi_metric_early_stopping.py` | Unused `from unittest.mock import MagicMock` |
| `tests/test_text_core.py` | Unused `import types` |
