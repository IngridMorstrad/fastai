...
- [DONE] Provide built-in callbacks that write training metrics to structured formats for popular visualization tools -- implemented as `CSVLogger` (CSV), `TensorBoardCallback` (TensorBoard), and `WandbCallback` (Weights & Biases)
